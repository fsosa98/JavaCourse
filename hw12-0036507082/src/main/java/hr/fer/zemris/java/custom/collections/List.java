...
/**
 * Interface List defines data structure and a set of 
 * methods for working with it.
 * 
 * Users can remove element from list, 
 * get element on index, insert elements,
...
public interface List extends Collection {
	 ...
	 * at the given position in list. Elements at position and at greater positions 
	...
	/**
	 * Searches the list and returns the index of 
