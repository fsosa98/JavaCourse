...
/**
 * Class ArrayIndexedCollection defines data structure and a set of 
 * methods for working with it. Class uses array for storing elements.
 * 
...
public class ArrayIndexedCollection implements List {
	...
	/**
	 * Default constructor.
	 * Initialize collection with default capacity.
	 * 
	 */
	 ...
	 * and initializes collection with default capacity.
	 * 
	...
	/**
	 * Constructor which adds elements of given collection to collection 
	 * and initializes collection with given capacity.
	 * 
	 * @param other given collection
	 ...
	 * 
	 * Users can check if next element is available,
	 * get next element.
	 *
	 */
