...
/**
 * Class ObjectStack defines data structure and a set of methods for working
 * with it. Class uses stack for storing elements.
 * 
 * Users can get size of collection, push elements, peek elements, pop element,
 * check if stack is empty or clear stack.
 * 
 * @author Filip
 */
public class ObjectStack {
	...
	/**
	 * This method returns last value pushed on stack from stack.
	 * 
	 * @return last value on stack
	 */
	public Object peek() {
