...
/**
 * Class Collection defines data structure and a set of methods for working with
 * it.
 * 
...
public interface Collection<T> {
	 ...
	 * @return true if value is in the collection false if value is not in the
	 *         collection
	 */
	 ...
	 * @return true if object with value is removed. false if object with value is
	 *         not removed.
	 */
	...
	/**
	 * This method calls {@link Processor#process(Object)} for each element of this
	 * collection.
	 * 
	...
	public default void addAll(Collection<? extends T> other) {
		...
		/**
		 * Class LocalClassProcessor represents processor that is used for adding values
		 * to this collection.
		 *
		 */
		class LocalClassProcessor implements Processor<T> {
	...
	/**
	 * This method adds into the current collection all elements from the given
	 * collection that satisfies test from tester. This other collection remains
	 * unchanged.
	 * 
